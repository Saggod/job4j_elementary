...
public class MathCalculator {
    ...
    public static double aummAllMeth(double first, double second) {
        return sum(first, second) + multiply(first, second) + difference(first, second) + division(first, second);
    }

    public static void main(String[] args) {
        System.out.println("Результат расчета равен: " + sumAndMultiply(10, 20));
        System.out.println("Результат первого задания равен: " + sumAndDiffAndDiv(10, 20));
        System.out.println("Результат второго задания равен: " + aummAllMeth(10, 20));
    }
}
